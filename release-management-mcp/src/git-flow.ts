...
Auto-generated by Release Management MCP
  ...
  async downmergeMainToDevelop(dryRun: boolean = false): Promise<string> {
    try {
      if (dryRun) {
        console.log("🔧 Dry run: Would perform downmerge main to develop workflow");
      ...
      const prTitle = "Downmerge main into develop";
...
*Generated by Release Management MCP*`;
      ...
      const prUrl = await this.createPullRequest(branchName, "develop", prTitle, prBody);
